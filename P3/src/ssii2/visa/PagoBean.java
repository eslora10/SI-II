...
public class PagoBean {
	...
	/*Annadidos en la P3 para recoger las instancias y las ip de los nodos del cluster*/
	private String ip;        
    ...
    /**
     * @return la direccion ip de la instancia 
     */
    public String getIp() {
        return this.ip;
    }
    ...
    /**
     * @param ip la direccion ip de la instancia
     */
    ...
    /**
     * @return la instancia que realizo el pago
     */
    ...
    /**
     * @param instancia la instancia que realizo el pago 
     */
